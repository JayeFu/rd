...
I_object_I = R_IE * object_I * R_IE';

M = M + I_Jp_E' * object_m * I_Jp_E + I_Jr_E' * I_object_I * I_Jr_E;
...
I_dJp_E = dAdt(I_Jp_E, q, dq);
I_dJr_E = dAdt(I_Jr_E, q, dq);
I_w_object = I_Jr_E * dq;

b = b + I_Jp_E' * object_m * I_dJp_E * dq;
b = b + I_Jr_E' * I_object_I * I_dJr_E * dq;
b = b + I_Jr_E' * cross(I_w_object, I_object_I * I_w_object);
